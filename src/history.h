...
constexpr int CUTNODE_CORRECTION_HISTORY_BASE_SIZE = 32768;  // has to be a power of 2
...
static_assert((CUTNODE_CORRECTION_HISTORY_BASE_SIZE & (CUTNODE_CORRECTION_HISTORY_BASE_SIZE - 1)) == 0,
              "CUTNODE_CORRECTION_HISTORY_BASE_SIZE has to be a power of 2");

static_assert((CORRHIST_BASE_SIZE & (CORRHIST_BASE_SIZE - 1)) == 0,
              "CORRHIST_BASE_SIZE has to be a power of 2");

inline int cutnode_correction_history_index(const Position& pos) {
    return pos.pawn_key() & (CUTNODE_CORRECTION_HISTORY_BASE_SIZE - 1);
}
