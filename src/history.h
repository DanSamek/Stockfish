...
inline int non_major_index(const Position& pos) {
    return pos.non_major_key() & (CORRECTION_HISTORY_SIZE - 1);
}
...
enum CorrHistType {
    ...
    NonMajor,      // By color and position of pawns and minor pieces
};
