...
constexpr int LOW_PLY_PAWN_HISTORY_BASE_SIZE   = 1024;  // has to be a power of 2
...
static_assert((LOW_PLY_PAWN_HISTORY_BASE_SIZE & (LOW_PLY_PAWN_HISTORY_BASE_SIZE - 1)) == 0,
              "LOW_PLY_PAWN_HISTORY_BASE_SIZE has to be a power of 2");

static_assert((CORRHIST_BASE_SIZE & (CORRHIST_BASE_SIZE - 1)) == 0,
              "CORRHIST_BASE_SIZE has to be a power of 2");

inline int low_ply_pawn_history_index(const Position& pos) {
    return pos.pawn_key() & (LOW_PLY_PAWN_HISTORY_BASE_SIZE - 1);
}
...
using LowPlyPawnHistory = Stats<std::int16_t, 8192, LOW_PLY_HISTORY_SIZE, PIECE_NB, SQUARE_NB, LOW_PLY_PAWN_HISTORY_BASE_SIZE>;
