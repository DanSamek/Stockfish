...
// CapturePieceToHistory is addressed by a move's [bucket][piece][to][captured piece type]
using CapturePieceToHistory = Stats<i16, 10692, BUCKET_COUNT, PIECE_NB, SQUARE_NB, PIECE_TYPE_NB>;
