...
inline int segment_index(const Position& pos) {
    return pos.segment_key(pos.square<KING>(pos.side_to_move())) & (CORRECTION_HISTORY_SIZE - 1);
}
...
enum CorrHistType {
    ...
    Segment,       // By color and 4x4 segment (our king square)
};
