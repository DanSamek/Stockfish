...
// CapturePieceToHistory is addressed by a move's [piece][improving][to][captured piece type]
using CapturePieceToHistory = Stats<std::int16_t, 10692, PIECE_NB, 2, SQUARE_NB, PIECE_TYPE_NB>;
