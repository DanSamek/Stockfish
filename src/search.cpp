...
int correction_value(const Worker& w, const Position& pos, const Stack* const ss) {
    ...
    const auto  kcv   =
      m.is_ok() ?  w.kingCorrectionHistory[pos.square<KING>(WHITE)][pos.square<KING>(BLACK)][pos.piece_on(m.to_sq())][us]
                 : 0;
...
void update_correction_history(const Position& pos,
    ...
    if (m.is_ok())
    {
        ...
        workerThread.kingCorrectionHistory[pos.square<KING>(WHITE)][pos.square<KING>(BLACK)][pos.piece_on(m.to_sq())][us] << bonus;
    }
}
